...
class CreateBackup(object):
    ...
    def on_post(self, req, resp):
        ...
        backup_job = self.backup_queue.enqueue(
            ...
            kwags={
                "description": "Backup process: folder {} gdrive {}".format(
                    backup_folder, remote_folder
                ),
                "job_id": job_id,
            },
            job_timeout="6h",
...
class SyncBackup(object):
    ...
    def on_post(self, req, resp):
        ...
        backup_job = self.backup_queue.enqueue(
            ...
            kwags={
                "description": "Sync process: folder {} gdrive {}".format(
                    backup_folder, remote_folder
                ),
                "job_id": job_id,
            },
...
class GetJobIDs(object):
    ...
    def on_get(self, req, resp):
        try:
            ...
            resp.body = "job_ids :{} \n Total jobs in queue {}".format(
                jobs_list, jobs_count
            )
        except Exception as e:
            resp.status = falcon.status_codes.HTTP_500
            resp.body = "Error {}".format(e)
